...
public class MacroMenuGui extends Gui implements IBindingsGui {
    ...
    public MacroMenuGui() {
        ...
        openChangeLog.setOnClick((button, sButton) -> OpenChangeLog.openChangeLog(true));
                ...
                if (override || (isKey == b.getEventMode().isKeyType())) {
                    ...
                    if (override || (!isKey || (isKey && (b.getEventMode().isKeyAllowed(isKeyDown))))) { //right mode
                        ...
                        if (override || b.getEventName().equals(eventName)) { //right event
                            ...
                            if (b.getScriptName() == null) {
                                return;
                            }
                            File f = new File(AdvancedMacros.MACROS_FOLDER, b.getScriptName());
    ...
    public void markDirty() {
        dirty = true;
        System.out.println("Profile marked for saving.");
    }
    ...
    public Text getTitle() {
        return Text.literal("Bindings Menu");
    }
