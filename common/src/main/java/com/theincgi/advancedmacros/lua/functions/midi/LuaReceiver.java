...
public class LuaReceiver implements Receiver {
    ...
    private String getControlName(int i) {
        switch (i) {
            case 0x00:
                return "Bank Select (Controller # 32 more commonly used)";
            case 0x01:
                return "Modulation Wheel";
            case 0x02:
                return "Breath Contoller";
            case 0x03:
                return "Undefined";
            case 0x04:
            ...
            case 0x40:
                return "Damper Pedal (Sustain) [Data Byte of 0-63=0ff, 64-127=On]";
            case 0x41:
                return "Portamento";
            case 0x42:
                return "Sostenuto";
            ...
            case 0x47:
                return "Sound Controller 2 (default: Timbre/Harmonic Content)";
            case 0x48:
            ...
            case 0x5B:
                return "Effects 1 Depth (previously External Effects Depth)";
            case 0x5C:
                return "Effects 2 Depth (previously Tremolo Depth)";
            case 0x5D:
                return "Effects 3 Depth (previously Chorus Depth)";
            case 0x5E:
                return "Effects 4 Depth (previously Detune Depth)";
            case 0x5F:
                return "Effects 5 Depth (previously Phaser Depth)";
            case 0x60:
            ...
            case 0x7D:
                return "Omni On";
            case 0x7E:
                return "Mono On (Poly Off)";
            case 0x7F:
                return "Poly On (Mono Off)";
            default:
                if (0x10 <= i && i <= 0x13) {
                    return "General Purpose Controllers (Nos. 1-4)";
                }
                if (0x20 <= i && i <= 0x3F) {
                    return "LSB for Controllers 0-31 (rarely implemented)";
                }
                if (0x4B <= i && i <= 0x4F) {
                    return "Sound Controller 6-10 (no defaults)";
                }
                if (0x50 <= i && i <= 0x53) {
                    return "General Purpose Controllers (Nos. 5-8)";
                }
                return "Undefined";
