...
public class LuaDebug extends DebugLib {
                    ...
                    thread = new Thread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                if (onScriptFinish != null) {
                                    onScriptFinish.onFinish(retValues);
                                }
                                status = Status.DONE;
    ...
    /**
     * Added for the ChatSendFilter which will go through multiple filters, this occurs in a
     * runnable<br> This will allow it to show up inside the running scripts list and be
     * cancel-able
     */
    ...
    public static class ThreadControls extends LuaTable {
        ...
        public static ThreadControls getControls(LuaThread t) {
            if (t == null) {
                throw new NullPointerException("LuaThread is null");
            }
